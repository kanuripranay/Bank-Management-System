...
<br><br>
<div align="center" style="background-color: #0076f4; height: 70px; width: 100%; color: white; position: absolute; top: 13%;""><h1>Edit Profile</h1></div>
...
<center>
  <form action="" method="POST">
    ...
    <table width="80%">
      <tr>
        <td colspan="2" align="right" style="border-top: 1px solid white;"><input type="submit" name="submit" value="SUBMIT" style="height: 40px; width: 150px; color: white; background-color: #0076f4"></td>
      </tr>
    </table>
  </form>
</center>
