...
<br><br>
<center>
  <div style="background-color: #0076f4; height: 45px; width: 100%; color: white; "><h1>Set Limit</h1></div>
  <br><br>
  ...
  <table style="border: white;" width="80%">
    <tr>
      <td style="border: white;" align="center"><input type="submit" name="submit" value="Continue" style="height: 40px; width: 150px; font-size: 20px; color: white; background-color: #0076f4"></td>
    </tr>
  </table>
  </form>
</center>
