...
<br><br>
<div align="center" style="background-color: #0076f4; height: 70px; width: 100%; color: white; position: absolute; top: 13%;"><h1>My Profile</h1></div>
...
<center>
  <table cellpadding="10">
    ...
    <col width="600">
    <tr>
      <td colspan="2" align="right" style="border-top: 1px solid white;"><input type="button" name="changepwd" value="CHANGE PASSWORD" onclick="window.location.href='password/password.php'" style="height: 40px; width: 180px; color: white; background-color: #0076f4"><input type="button" name="editprofile" value="EDIT PROFILE" onclick="window.location.href='editprofile.php'" style="height: 40px; width: 150px; color: white; background-color: #0076f4"></td>
    </tr>
    <tr bgcolor="#ffffe6">
      <td><b>Name : </b></td>
