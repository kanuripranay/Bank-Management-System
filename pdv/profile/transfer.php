...
<br><br>
<div align="center" style="background-color: #0076f4; height: 70px; width: 100%; color: white; position: absolute; top: 13%;"><h1>Transfer Money</h1></div>
...
<center>
  ...
  <form action="" method="POST">
    ...
    <table width="80%">
      <tr>
        <td align="right"><input type="submit" name="submit" value="PAY NOW" style="height: 40px; width: 150px; font-size: 20px; color: white; background-color: #0076f4"></td>
      </tr>
    </table>
  </form>
</center>
