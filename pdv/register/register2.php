...
<br><br>
  <center>
    <div style="postion: absolute; top: 25%; background-color: #0076f4; height: 80px; width: 100%; align-items: center; color: white "><h1>Registration : Step 2</h1>
  ...
  <form action="../db/register.php" method="post">
    ...
    <table width="80%">
      <tr>
        <td align="center">
          <input type="submit" name="submit" value="REGISTER ME" style="height: 45px; width: 250px; font-size: 25px; color: white; background-color: #0076f4">
        </td>
      </tr>
    </table>
  </form>
