...
<br><br>
  <center>
    <div style="postion: absolute; top: 25%; background-color: #0076f4; height: 80px; width: 100%; align-items: center; color: white "><h1>New User Registration</h1>
  ...
  <form action="" method="POST">
    ...
    <br>
    <input type="submit" name="submit" value="Submit" style="height: 45px; width: 250px; font-size: 25px; color: white; background-color: #0076f4">
  </form>
  </center>
</body>
</html>
